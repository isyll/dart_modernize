...
void main() {
  group('parseTrackedChanges', () {
    test('keeps modified and staged tracked entries', () {
    ...
    test('drops untracked ?? entries', () {
      expect(parseTrackedChanges('?? lib/new.dart\n'), isEmpty);
    });

    test('keeps tracked entries but drops untracked and blank lines', () {
      expect(parseTrackedChanges(' M a.dart\n?? b.dart\n\nR  old -> new\n'), [
        ' M a.dart',
        'R  old -> new',
      ]);
    });

    test('a clean tree yields nothing', () {
